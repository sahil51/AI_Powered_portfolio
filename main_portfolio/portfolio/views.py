...
def api_create_blog_post(request):
    ...
    {
      "title": "My first blog",
      "content": "Professional content generated by Gemini...",
      "image_url": "https://res.cloudinary.com/dfskgiox/image/upload/...",
      "status": "draft",
      "author": "AI",
      "source": "telegram"
    }
    ...
    # Optionally download external image URL into local Django ImageField
    if image_url:
        try:
